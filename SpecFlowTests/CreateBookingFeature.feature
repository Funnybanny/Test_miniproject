...
Scenario: Start date is at the start and end date is at the end of occupancy
	Given Start date is at the start of occupancy
	And End date is at the end of occupancy
	When Booking is created
	Then Booking is invalid

Scenario: Start date is at the start and end date is at the start of occupancy
	Given Start date is at the start of occupancy
	And End date is at the start of occupancy
	When Booking is created
	Then Booking is invalid

Scenario: Start date is at the end and end date is at the end of occupancy
	Given Start date is at the end of occupancy
	And End date is at the end of occupancy
	When Booking is created
	Then Booking is invalid
