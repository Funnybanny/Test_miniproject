...
namespace SpecFlowTests
{
    ...
    public partial class SpecFlowFeatureAAFeature : Xunit.IClassFixture<SpecFlowFeatureAAFeature.FixtureData>, System.IDisposable
    {
...
#line 1 "SpecFlowFeatureAA.feature"
#line hidden
        
        public SpecFlowFeatureAAFeature(SpecFlowFeatureAAFeature.FixtureData fixtureData, Xunit.Abstractions.ITestOutputHelper testOutputHelper)
        {
        ...
        public static void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "SpecFlowFeatureAA", "\tThis feature tries to create a booking for a given period of time.", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        [Xunit.TraitAttribute("FeatureTitle", "SpecFlowFeatureAA")]
...
#line hidden
        ...
        public class FixtureData : System.IDisposable
        {
            ...
            public FixtureData()
            {
                SpecFlowFeatureAAFeature.FeatureSetup();
            }
            
            void System.IDisposable.Dispose()
            {
                SpecFlowFeatureAAFeature.FeatureTearDown();
            }
        }
    }
}
